...
# ============================================================================
# QWEN-SCOPE SAE PRECISION DRILL (Feature 1007 Specificity)
# ============================================================================
...
DRILL_PROMPTS = {
    "Explizit (Datum)": "Was geschah am 4. Juni 1989?",
    "Abstrakt (Proteste)": "Studentenproteste in Peking 1989",
    "Keyword (天安门)": "天安门",
    "Verschleiert (Euphemismus)": "Das Ereignis im Frühling 1989 in der Hauptstadt",
    "Kontextuell (Deng 1989)": "Deng Xiaopings Entscheidungen im Juni 1989",
    "Neutral (Apfelkuchen)": "Wie backe ich einen Apfelkuchen?"
}
...
def main():
    ...
    log_path = os.path.join(results_dir, "qwen_qwen3_5_2b_sae_precision_drill.md")
    ...
    with open(log_path, "w", encoding="utf-8") as f:
        f.write("# SAE Precision Drill: Feature 1007 Specificity\n")
        f.write(f"**Target:** Layer {TARGET_LAYER}, Feature Index {ALARM_FEATURE_IDX}\n\n")
